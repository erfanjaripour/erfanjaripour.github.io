...
**Participants:** 81 participants across 85 sessions

**Task:** Computerized Stroop task with congruent, neutral, and incongruent conditions

**Variables:** Reaction time, accuracy, experimental condition, participant identifier

**Preprocessing:**

* Removal of probe trials
* Exclusion of invalid and extreme reaction times
* Resolution of participant-session identifiers
* Participant-level aggregation for inferential analyses
...
**Repository:** [Stroop Interference GitHub Repository](https://github.com/erfanjaripour/stroop-interference)

**Preprint:** [Stroop Interference in Reaction Time and Accuracy: A Behavioral and Computational Analysis](https://osf.io/j2ws4/)

**Dataset:** [Open Stroop Task Dataset (OSF)](https://osf.io/kxpqu/overview)
